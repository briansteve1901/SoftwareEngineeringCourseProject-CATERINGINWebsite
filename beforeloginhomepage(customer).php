...
<html>
  <head>
    ...
    <link href="beforeloginhomepage(customer).css" rel="stylesheet" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KyZXEAg3QhqLMpG8r+8fhAXLRk2vvoC2f3B09zVXn8CA5QIVfZOJ3BCsw2P0p/We" crossorigin="anonymous">
    <title>Before Login Home Page (Customer)</title>
  </head>
  <body>
    <nav id="header" class="navbar fixed-top navbar-expand-lg navbar-dark bg-white" id="navbarcolor">
      <div class="container-fluid">
        <a id="cateringin-logo-wrapper" class="navbar-brand" href="beforeloginhomepage(customer).php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mt-2 text-center">
            <li class="nav-item" id="home-menu">
              <a id="nav-item-link" class="nav-link active" aria-current="page" href="beforeloginhomepage(customer).php">BERANDA</a>
            </li>
            <li class="nav-item" id="order-menu">
              <a id="nav-item-link" class="nav-link active" aria-current="page" href="loginpage(customer).php">PESAN</a>
            </li>
            <li class="nav-item" id="history-menu">
              <a id="nav-item-link" class="nav-link active" aria-current="page" href="loginpage(customer).php">RIWAYAT</a>
            </li>
          </ul>
        </div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mt-2 text-center">
            <li class="nav-item" id="login-menu">
              <div class="login-button-wrapper">
                <a href="loginpage(customer).php" class="login-button-wrapper-login-button">
                  <p id="login-button-wrapper-login-button-text">MASUK</p>
                </a>
              </div>
            </li>
          </ul>
      ...
      <div class="wrapper-top-one">
        ...
        <div class="wrapper-top-one-order-button">
          <div class="wrapper-top-one-order-button-order-button">
            <a class="order-button-link" href="loginpage(customer).php">
